package com.bless.common.enums;
...
public enum ImUrlRouteWayEnum {
     ...
     * 随机
     */
    RAMDOM(1,"com.bless.common.route.algorithm.random.RandomHandle"),


    /**
     * 1.轮训
     */
    LOOP(2,"com.bless.common.route.algorithm.loop.LoopHandle"),

    /**
     * HASH
     */
    HASH(3,"com.bless.common.route.algorithm.consistenthash.ConsistentHashHandle"),
    ;
